...
The system SHALL track the date of the last database export. If more than 14 days have passed since the last export, the system SHALL display a non-blocking reminder suggesting the user export a backup.

#### Scenario: Backup reminder after 14 days
- **WHEN** the user opens the app and the last export was more than 14 days ago
- **THEN** the system SHALL display a dismissible notification reminding them to export a backup
